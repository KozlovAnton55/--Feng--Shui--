...
LOGIN_REDIRECT_URL = '/' # Куда перенаправлять после успешного логина (если нет параметра next)
LOGIN_URL = '/login/' # URL страницы логина

DELIVERY_CENTER_LAT = 55.117082  # Широта центра доставки (Обнинск)
DELIVERY_CENTER_LON = 36.597014  # Долгота центра доставки (Обнинск)